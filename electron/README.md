# Tianmao API Electron Desktop App

This directory contains the Electron wrapper for Tianmao API, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/Tianmao API/data/`
  - Windows: `%APPDATA%/Tianmao API/data/`
  - Linux: `~/.config/Tianmao API/data/`
