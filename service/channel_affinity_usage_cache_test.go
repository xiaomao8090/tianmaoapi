...
func uniqueChannelAffinityStatsKey() (string, string, string) {
	id := channelAffinityStatsTestSeq.Add(1)
	return fmt.Sprintf("rule_%d", id), "default", fmt.Sprintf("fp_%d", id)
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName, usingGroup, keyFP := uniqueChannelAffinityStatsKey()
